...
Note: You can leave out the Servo and do something else, for example flash a LED. You only need to update the code in the [runRobot()](esp32-device-code/esp32code.ino) function in the main arduino program file. 
